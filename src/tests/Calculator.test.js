...
describe ('Calculate', ()=>{
    ...
    it('should throw an error for expressions starting with any other operator apart of "-"', ()=>{
        expression = '*30-6';
    ...
    // it('should throw an error for expressions divided by "0"', ()=>{
    //     expression = '30/0';
    //     expect(calculate(expression)).toThrow();
    // });
    ...
    // it('ignores every expression after multiple operators besides "**" and "**/" while evaluating the expression correctly', ()=>{
    // it('ignores every expression after multiple operators besides "**" while evaluating the expression correctly', ()=>{
    it('ignores every expression after multiple operators while evaluating the expression correctly', ()=>{
        ...
        // expression = '2+3+3**2';
        // expect(calculate(expression)).toBe(14);
